...
function DSD() {
    ...
    return (
        <div>
            <div className="demo">
                <div className="title">
                    <h2><span>{professionalSubject} </span><sub>18EC754</sub></h2>
                ...
                <div className="courses">
                    ...
                    <div className="box2">
                        <ul>
                            ...
                            <li>FacultyDr. Manu T.M , Mr. Ravi Hosmani and Mr. Vishwas patil and Rakesh Hiremath ,Dept of ECE,
                                KLEIT</li>
                            <br></br>
                        </ul>
                    </div>
                            ...
                            <div class="accordion accordion-flush " id="accordionFlushExample">
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">
                                            1. Use the industry-standard hardware description language VHDL into the digital design process.
                                            <br></br>
                                            2. Design VHDL models ranging in complexity from a simple adder to more complex circuits.
                                            <br></br>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">
                                            ...
                                            <br></br>
                                            2. Implement various Combinational and sequential circuits using VHDL descriptions. Writes imple
                                            VHDL programs in different styles.
                                            <br></br>
                                            ...
                                            <br></br>
                                            5. Write the programs more effectively using Verilog tasks and directives.
                                            <br></br>
