        ...
        <div className="courses">
          ...
          <div className="box2">
            <ul>
              ...
              <li>
                Prerequisites: Basic knowledge of Environmental Science and
                Sustainability concepts in engineering.
              </li>
              <li>
                Faculty in charge: Prof. D.R.Kulkarni,Department of Civil
                Engineering,KLEIT, Hubballi
              </li>
              <br></br>
            </ul>
          </div>
            ...
            <div className="dropCollapse">
              ...
              >
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      This course will enable students to gain knowledge in
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body">
                      ...
                      environmental management system standards.<br></br>
                      2. Lead the pollution prevention assessment team and
                      implement wasteminimization options.<br></br>
                      3. Develop, implement, maintain and audit Environmental
                      Management Systems for organization.<br></br>
                    </div>
                  </div>
                </div>
                ...
                <div class="accordion-item">
                  ...
                  >
                    <div class="accordion-body details">
                      ...
                      a. Course on Environment Management (web course) by
                      Dr.T.V.Ramachandra,IISC, Bangalore.<br></br>
                      b. CourseonIntroduction to Environmental Science and
                      Engineering- Fundamental and Sustainability concepts
                      byDrBrajesh Kumar Dubey, IIT Kharagpur<br></br>
                      <br></br>
                      <p>
                        <b> Course Assignments</b>
                      </p>
                      1. Obtain a form for submission of Environmental Statement
                      from local pollution control board office and list
                      benefits of this statement.<br></br>
                      2. Conduct waste audit of local industry and submit a
                      waste audit report.<br></br>
                      ...
                      <br></br>
                      1.
                      ChristopherSheldonandMarkYoxon,“InstallingEnvironmentalmanagementSystems–a
                      Step by step guide” Earthscan Publications Ltd, London,
                      1999.<br></br>
                      2.
                      ISO14001/14004:Environmentalmanagementsystems–RequirementsandGuidelines–
